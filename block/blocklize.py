...
MODEL_BLOCKS = {
    ...
    "regnet_y_32gf": [
        ...
        "trunk_output.block2.block2-1",
        "trunk_output.block2.block2-2",
        "trunk_output.block2.block2-3",
        "trunk_output.block2.block2-4",
        "trunk_output.block3.block3-0",
        "trunk_output.block3.block3-1",
        "trunk_output.block3.block3-2",
        "trunk_output.block3.block3-3",
        "trunk_output.block3.block3-4",
        "trunk_output.block3.block3-5",
        "trunk_output.block3.block3-6",
        "trunk_output.block3.block3-7",
        "trunk_output.block3.block3-8",
        "trunk_output.block3.block3-9",
        "trunk_output.block3.block3-10",
        "trunk_output.block3.block3-11",
    ...
    "regnet_y_1_6gf": [
        ...
        "trunk_output.block3.block3-11",
        "trunk_output.block3.block3-12",
        "trunk_output.block3.block3-13",
        "trunk_output.block3.block3-14",
        "trunk_output.block3.block3-15",
        "trunk_output.block3.block3-16",
        "trunk_output.block4.block4-0",
...
MODEL_STATS = {
    "resnet18": dict(
        arch="resnet18", top1=69.758, param=11.69, backend="pytorch", type="cnn"
    ),
    "resnet50": dict(
        arch="resnet50", top1=76.130, param=25.56, backend="pytorch", type="cnn"
    ),
    "resnet50mocov2": dict(
        arch="resnet50", top1=71.1, param=25.56, backend="pytorch", type="cnn"
    ),
    "resnet50byol": dict(
        arch="resnet50", top1=67.68, param=25.56, backend="pytorch", type="cnn"
    ),
    "resnet50simclr": dict(
        arch="resnet50", top1=58.92, param=25.56, backend="pytorch", type="cnn"
    ),
    "resnet101": dict(
        arch="resnet101", top1=77.374, param=44.55, backend="pytorch", type="cnn"
    ),
    "resnet152": dict(
        arch="resnet152", top1=78.312, param=60.19, backend="pytorch", type="cnn"
    ),
    "efficientnet_b7": dict(
        arch="efficientnet_b7", top1=84.122, param=66.35, backend="pytorch", type="cnn"
    ),
    "efficientnet_b6": dict(
        arch="efficientnet_b6", top1=84.008, param=43.04, backend="pytorch", type="cnn"
    ),
    "efficientnet_b5": dict(
        arch="efficientnet_b5", top1=83.444, param=30.39, backend="pytorch", type="cnn"
    ),
    "efficientnet_b4": dict(
        arch="efficientnet_b4", top1=83.384, param=19.34, backend="pytorch", type="cnn"
    ),
    "efficientnet_b3": dict(
        arch="efficientnet_b3", top1=82.008, param=12.23, backend="pytorch", type="cnn"
    ),
    "efficientnet_b2": dict(
        arch="efficientnet_b2", top1=80.608, param=9.11, backend="pytorch", type="cnn"
    ),
    "efficientnet_b1": dict(
        arch="efficientnet_b1", top1=78.642, param=7.79, backend="pytorch", type="cnn"
    ),
    "efficientnet_b0": dict(
        arch="efficientnet_b0", top1=77.692, param=5.29, backend="pytorch", type="cnn"
    ),
    ...
    "mobilenetv3_large_075": dict(
        arch="mobilenetv3_large_075",
        top1=73.440,
        param=3.99,
        backend="mytimm",
        type="cnn",
    ...
    "regnet_y_32gf": dict(
        arch="regnet_y_32gf", top1=80.808, param=145.05, backend="pytorch", type="cnn"
    ),
    "regnet_y_16gf": dict(
        arch="regnet_y_16gf", top1=80.424, param=83.59, backend="pytorch", type="cnn"
    ),
    "regnet_y_8gf": dict(
        arch="regnet_y_8gf", top1=80.032, param=39.18, backend="pytorch", type="cnn"
    ),
    "regnet_y_3_2gf": dict(
        arch="regnet_y_3_2gf", top1=78.948, param=19.44, backend="pytorch", type="cnn"
    ),
    "regnet_y_1_6gf": dict(
        arch="regnet_y_1_6gf", top1=77.950, param=11.20, backend="pytorch", type="cnn"
    ),
    "regnet_y_800mf": dict(
        arch="regnet_y_800mf", top1=76.312, param=6.26, backend="pytorch", type="cnn"
    ),
    ...
    "swsl_resnext101_32x8d": dict(
        arch="swsl_resnext101_32x8d",
        top1=84.290,
        param=88.79,
        backend="mytimm",
        type="cnn",
    ),
    "swsl_resnext50_32x4d": dict(
    ...
    "vit_small_patch16_224mocov3": dict(
    ...
    "vit_base_patch16_224mocov3": dict(
